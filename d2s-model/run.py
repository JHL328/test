...
if __name__ == '__main__':
    ...
    # shared params
    parser.add_argument("-model_path", default='/soe/haolong/2023_winter/NLP_244/NLP244-project/document2slides/model')
    parser.add_argument("-cache_path", default='/soe/haolong/2023_winter/NLP_244/NLP244-project/document2slides/cache')
    parser.add_argument("-result_path", default='/soe/haolong/2023_winter/NLP_244/NLP244-project/document2slides/results')

    # params for caching IR
    parser_ir = subparsers.add_parser('ir', help='cache information retrieval documents')
    parser_ir.add_argument("-slide_json", default='/soe/haolong/2023_winter/NLP_244/NLP244-project/document2slides/input/acl_slides_prefilter.json')
    parser_ir.add_argument("-paper_path", default='/soe/haolong/2023_winter/NLP_244/NLP244-project/document2slides/input/sciduet_papers')
    parser_ir.add_argument("-split_path", default="/soe/haolong/2023_winter/NLP_244/NLP244-project/document2slides/input/split")
    parser_ir.add_argument("-ir_model", default=None)
